        ...
        <div className="mb-8">
          ...
          <div className="mt-5 ">
            ...
            <div className="flex items-center justify-between space-x-2">
              ...
              <button className="p-3 rounded-md flex items-center justify-center text-gray-500 hover:bg-orange-100 hover:text-gray-700 focus:!outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 ">
                <svg
                  className="h-6 w-6 "
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            {[1, 2, 3, 4, 5, 6].map((_, i) => (
              <div key={i}>
                ...
                <span className="text-sm text-gray-700 font-medium">$6</span>
              </div>
            ))}
          </div>
        </div>
